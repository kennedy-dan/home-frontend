...
const Checkout = () => {
  ...
  const amount = cartItem && Object.keys(getcart?.result?.cartItems).reduce(
    (totalPrice, key) => {
  ...
  console.log(getbilling?.result?.address.address);
  const openLogin = () => {
    setOpen(!open);
  };
  const openPass = () => {
  ...
  const login = (
    <div className="mt-8">
      ...
      <div className=" mt-8 text-gray-800">
        ...
        <input className="outline-none px-4 py-2 md:py-6 border w-full " />
      </div>
      <div className=" mt-8 text-gray-800">
      ...
      <div>
        <button className="py-3 px-3  md:py-4 md:px-5 text-white bg-gray-800  hover:bg-white hover:text-gray-800 border border-black mt-4 font-semibold text-[12px] md:text-[15px]">
          Login
        </button>
      </div>
    </div>
        ...
        <div className="mt-10">
          <div className="grid md:grid-cols-2 gap-3">
            <div>
              ...
              <div className="mt-8">
                <p className="text-base font-semibold mb-2">Email address *</p>
                <input
              ...
              {/* {billing.status !== "loading" && ( */}
                ...
                >
                         {billing.status === 'loading' ? <ClipLoader color="#ffffff" size={12} /> : "Save address"}
